 ...
 * @author AbuKhleif
 */
public class WriterTester_Guru99Errors {
    ...
    private static void createNewAccount() {
        ...
        writer.addAction(new VerifyText("Account Generaaaated Successfully"));
    }
...
//        writer.addAction(new FillElement("dob", "0019940522"));
        ...
        writer.addAction(new VerifyText("Customer Registered Successfully, Wohooo!!!"));
    ...
    private static void login() {
        ...
        writer.addAction(new VerifyText("Welcome To Manager's Page of Guru99 Bank, ahlan ahlan"));
    }
