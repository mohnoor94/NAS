...
public class Base {
    ...
    /**
     * If (find) com.abukhleif.akfnas.samples if the page contains a certain sentence,
     * otherwise com.abukhleif.akfnas.samples if it's not contain it
     *
     * @param message
     * @param find
     */
    ...
    /**
     * If (find) com.abukhleif.akfnas.samples equality of two sentences,
     * otherwise com.abukhleif.akfnas.samples if they are not equal
     *
     * @param message1
     * @param message2
     * @param find
    ...
    /**
     * Find com.abukhleif.akfnas.action by id, name, xpath, etc...
     *
     * @param key
     * @return WebElement
     */
     ...
     * @return text of the com.abukhleif.akfnas.action
     */
     ...
     * @param index         of com.abukhleif.akfnas.action to select
     */
