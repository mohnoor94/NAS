...
import com.abukhleif.akfnas.runtime.MethodInvocationUtils;
import com.abukhleif.akfnas.runtime.RuntimeCompiler;
...
public class Custom extends Action {
    ...
    private String getImportsAsString() {
        if (getImports().isEmpty()) {
            return "import com.abukhleif.akfnas.framework.Base;\n";
        }
        ...
        sb.append("import com.abukhleif.akfnas.framework.Base;\n");
        return sb.toString();
    }
