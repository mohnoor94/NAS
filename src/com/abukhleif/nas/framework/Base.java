package com.abukhleif.nas.framework;
...
public class Base {
    ...
    /**
     * If (find) com.abukhleif.nas.samples if the page contains a certain sentence,
     * otherwise com.abukhleif.nas.samples if it's not contain it
     *
     * @param message
     * @param find
     */
    ...
    /**
     * If (find) com.abukhleif.nas.samples equality of two sentences,
     * otherwise com.abukhleif.nas.samples if they are not equal
     *
     * @param message1
     * @param message2
     * @param find
    ...
    /**
     * Find com.abukhleif.nas.action by id, name, xpath, etc...
     *
     * @param key
     * @return WebElement
     */
     ...
     * @return text of the com.abukhleif.nas.action
     */
     ...
     * @param index         of com.abukhleif.nas.action to select
     */
