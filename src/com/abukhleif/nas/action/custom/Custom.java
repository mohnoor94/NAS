package com.abukhleif.nas.action.custom;

import com.abukhleif.nas.action.Action;
import com.aventstack.extentreports.Status;
import com.abukhleif.nas.framework.Reporter;
import com.abukhleif.nas.runtime.MethodInvocationUtils;
import com.abukhleif.nas.runtime.RuntimeCompiler;
...
public class Custom extends Action {
    ...
    private String getImportsAsString() {
        if (getImports().isEmpty()) {
            return "import com.abukhleif.nas.framework.Base;\n";
        }
        ...
        sb.append("import com.abukhleif.nas.framework.Base;\n");
        return sb.toString();
    }
