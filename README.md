...
## Run and Testing:
* Project includes many samples files (under xml folder) which can be used as a reference or a guide
to help you write your own files.
* Project also includes the Java classes (under src/samples folder) which used to generate the samples files,
...
* ExecuterTester Class (under src/samples folder) is an example of how can the files tests
