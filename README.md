...
An advanced -OPEN SOURCE- automation com.abukhleif.akfnas.framework (based on Selenium) with custom code injection ability. 
...
XML-based com.abukhleif.akfnas.samples cases, the com.abukhleif.akfnas.samples cases can be manually written as xml files or
automatically generated by convert java codes to xml files.
* Each com.abukhleif.akfnas.samples file will generate a report after executing it.
...
* Test File Hierarchy:
   ...
   Note: Site, Scenario, and units support dealing with null values in case the user does not need
      to deal with (some of) their properties. Provided com.abukhleif.akfnas.samples can illustrate some of these cases.
...
* Supported Actions:
    * Main Actions:
        ...
        * Store: Store com.abukhleif.akfnas.data from any web page for later uses.
        * Manual Store: Store any com.abukhleif.akfnas.data for later uses [entered manually by user].
    ...
    * Advanced Actions:
        * **Custom**: Gives the user the ability to inject the scenarios with custom Java code, for any reason
        or unsupported features in the com.abukhleif.akfnas.framework. The injected code will be compiled and executed
        at com.abukhleif.akfnas.runtime (using the src/com.abukhleif.akfnas.runtime package classes). Additional actions with custom code:
            ...
            * **Extend**: Allows the user to inherit any superclass.
                * By default: our base com.abukhleif.akfnas.framework is inherited.
...
* **Advanced Reporting System**: the Extent com.abukhleif.akfnas.framework is used for reporting every step in the scenarios.
    ...
    * Each step can have one of these statuses:
        ...
        * Note: Step contains an info and not a test.Dependancies
    ...
    * Full features of the reporting com.abukhleif.akfnas.framework can be found at: http://extentreports.com
...
'com.abukhleif.akfnas.midtier' package, which contain 2 classes:
...
* Samples provided for a quick start using the com.abukhleif.akfnas.framework.
...
* Project also includes the Java classes which used to generate the com.abukhleif.akfnas.samples files,
 you can also use them as a guide if you prefer to write your com.abukhleif.akfnas.samples files using
...
### Samples:
* All Samples can be found at: http://www.abukhleif.com/projects-com.abukhleif.akfnas.data/AKF-NAS/com.abukhleif.akfnas.samples/
    * Java Samples: Contains the Java Classes which used to generate the XML test files.
    * XML: XML test file com.abukhleif.akfnas.samples.
...
to provide the team with advanced reports and visual com.abukhleif.akfnas.data summaries.
    * Full features of Extent can be found at: http://extentreports.com/
    * All report com.abukhleif.akfnas.samples updated to the new version of reports.
* Other minor changes.
...
#### V N3.2:
* Add **Extend** statement to the **custom code** com.abukhleif.akfnas.action, using this com.abukhleif.akfnas.action
the user could extend any Java class.
    * By default: Base com.abukhleif.akfnas.framework class is inherited.
* Add **Implement** statement to the **custom code** com.abukhleif.akfnas.action, using this com.abukhleif.akfnas.action
...
* Other minor changes:
        ...
        * New com.abukhleif.akfnas.samples added to (java com.abukhleif.akfnas.samples/ reports/ xml files).

#### V N3.1 - N3.1.2:
* User can add **custom notes** to the report.
* Add **Import** statements to the **custom code** com.abukhleif.akfnas.action.
* Other minor changes:
...
#### V N3.0:
* Add **Custom** com.abukhleif.akfnas.action, which enable the user (Tests File writer) to 
inject a java code and execute it directly in case of he/she did not find the
 feature he/she look about in our com.abukhleif.akfnas.framework.
* Improve Report design.
* Improve Reporter and Base com.abukhleif.akfnas.framework.
...
* Base com.abukhleif.akfnas.framework code clean up.
...
* Reports titled with help of xml file name which used to run the com.abukhleif.akfnas.samples in addition
...
#### V1.7:
* Adding any com.abukhleif.akfnas.action to an instance of Writer class results in adding it directly,
**no need for committing each group of actions** separately.
* Other minor changes and bugs fixing.

#### V1.6:
* Fix FillElement com.abukhleif.akfnas.action reading process from stored com.abukhleif.akfnas.data.
* Add **VerifyAlert** and **RespondAlert** actions which helps in dealing with
popup alerts from websites.
* Form **Submit** com.abukhleif.akfnas.action supports both submitting by the submit method via any
...
#### V1.5:
* New (and better) **design** for reports.
* Add Form **Submit** as a new com.abukhleif.akfnas.action, this will help in execute other actions
and/or verifications either before or after the form submit com.abukhleif.akfnas.action.
...
#### V1.4:
* Add **Click** com.abukhleif.akfnas.action.
* Add **ClickCheckbox** com.abukhleif.akfnas.action.
* Add **FillElement** com.abukhleif.akfnas.action, to fill text input fields.
* Add **Store** com.abukhleif.akfnas.action, this com.abukhleif.akfnas.action help the user (QA) to store any com.abukhleif.akfnas.data from
the web page/form and use it anywhere during the com.abukhleif.akfnas.samples.
* Add **ManualStore** com.abukhleif.akfnas.action, this com.abukhleif.akfnas.action help the user (QA) to store any
useful com.abukhleif.akfnas.data and use it anywhere during the com.abukhleif.akfnas.samples.
* Update **Data** class to store com.abukhleif.akfnas.data via Store and ManualStore actions, 
in addition to other com.abukhleif.akfnas.data.
* Add **Text** com.abukhleif.akfnas.action, this com.abukhleif.akfnas.action verifies if the page contain this text.
* Add **NotText** com.abukhleif.akfnas.action, this com.abukhleif.akfnas.action verifies if the page does not contain
this text, useful for error messages discovering.
* Add **Select** com.abukhleif.akfnas.action, to select any option from a dropDown (or dropUp) menu.
...
* Update **Site** com.abukhleif.akfnas.scope class, and add name and url properties to it.
* Other minor changes and bugs fixing.

#### V1.3:
* Add **Data** to store com.abukhleif.akfnas.data, both the com.abukhleif.akfnas.data stored by the user, and some
other needed com.abukhleif.akfnas.data like the main site url.
* Other minor changes and bugs fixing.

#### V1.2:
* Add **Action** abstract class, all actions extend this class, each page now
has only to have a list of actions, not a list for each com.abukhleif.akfnas.action type,
...
actions of the page.
* Update **Scenario** com.abukhleif.akfnas.scope class.
* Add Main **Site** com.abukhleif.akfnas.scope class.
* Other minor changes and bugs fixing.
...
* Add **Page** unit.
* Add **Scenario** com.abukhleif.akfnas.scope.
* Add **Scope** interface.
* Other minor changes and bugs fixing.
